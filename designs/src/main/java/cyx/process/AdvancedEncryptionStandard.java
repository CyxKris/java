...
public class AdvancedEncryptionStandard {
    ...
    public static void createKey(final String myKey, final String algorithm) {
    ...
    public static String encrypt(final String strToEncrypt, final String key, final String algorithm) {

        try {

            createKey(key, algorithm);
    ...
    public static String decrypt(final String strToDecrypt, final String key, final String algorithm) {
